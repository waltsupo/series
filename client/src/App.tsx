...
const AuthWrapper = ({ Component, routeProps }: { Component: React.FC; routeProps: RouteProps }) => {
  ...
  return (
    <Router history={history}>
      <Switch>
        ...
        <Route exact path="/latest" render={(props) => <AuthWrapper Component={LatestEpisodes} routeProps={props} />} />
        <Route exact path="/series" render={(props) => <AuthWrapper Component={SeriesList} routeProps={props} />} />
        <Route path="/series/:seriesId" render={(props) => <AuthWrapper Component={SeriesPage} routeProps={props} />} />
